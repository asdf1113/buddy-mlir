...
void printDebugScalar(int rank, int iter, int layer,
...
void printDebugPredToken(int rank, int iter, int tokenId,
  ...
  if (rank == FrontendRank) {
    ...
    for (int i = 1; i <= generateLen; i++) {
      ...
      if (shouldTraceDecodeIter(i)) {
        printDebugScalar(rank, i, -1, "decode.cache_position",
                         cachePosition.getData()[0]);
        printDebugScalar(rank, i, -1, "decode.input_token_id",
                         inputContainerDecode.getData()[0]);
        printDebugTensorSummary("mha23", rank, i, -1, "decode0.hidden",
                                resultContainerDecodePtr->data.getData(),
                                HiddenSize0);
        printDebugTensorSummary("mha23", rank, i, -1, "decode0.mask",
                                resultContainerDecodePtr->mask.getData(),
                                MaxTokenLength);
        printDebugTensorSummary("mha23", rank, i, -1, "decode0.cos",
                                resultContainerDecodePtr->cos.getData(),
                                HiddenSize);
        printDebugTensorSummary("mha23", rank, i, -1, "decode0.sin",
      ...
      if (shouldTraceDecodeIter(i)) {
        printDebugTensorSummary("mha23", rank, i, -1, "decode.local_hidden",
      ...
      for (int m = 0; m < times; m++) {
        ...
        if (shouldTraceDecodeIter(i) && shouldTraceDecodeLayer(m)) {
          printDebugTensorSummary("mha23", rank, i, m, "decode.rms1.out",
        ...
        if (shouldTraceDecodeIter(i) && shouldTraceDecodeLayer(m)) {
          printDebugTensorSummary("mha23", rank, i, m,
                                  "decode.mha.part2.qcache",
                                  kvDecodeContainerTempPtr->qcache.getData(),
                                  6 * HiddenSize);
          printDebugTensorSummary("mha23", rank, i, m,
                                  "decode.mha.part2.kcache",
                                  kvDecodeContainerTempPtr->kcache.getData(),
                                  HiddenSize);
          printDebugTensorSummary("mha23", rank, i, m,
                                  "decode.mha.part2.vcache",
                                  kvDecodeContainerTempPtr->vcache.getData(),
                                  HiddenSize);
        }
        ...
        if (shouldTraceDecodeIter(i) && shouldTraceDecodeLayer(m)) {
          printDebugTensorSummary("mha23", rank, i, m, "decode.add1.out",
                                  subResultContainerDecode.getData(),
                                  HiddenSize0);
        }
        ...
        if (shouldTraceDecodeIter(i) && shouldTraceDecodeLayer(m)) {
          printDebugTensorSummary("mha23", rank, i, m, "decode.rms2.out",
                                  sub3DContainerDecode.getData(), HiddenSize0);
        }
        ...
        mhaOutputPtrDecode = tmp2DContainerDecode.getData();
        if (shouldTraceDecodeIter(i) && shouldTraceDecodeLayer(m)) {
          printDebugTensorSummary("mha23", rank, i, m, "decode.mlp.local_out",
                                  mhaOutputPtrDecode, HiddenSize0);
        }
        ...
        if (shouldTraceDecodeIter(i) && shouldTraceDecodeLayer(m)) {
          printDebugTensorSummary("mha23", rank, i, m, "decode.add2.out",
                                  subResultContainerDecode.getData(),
                                  HiddenSize0);
        }
      ...
      if (shouldTraceDecodeIter(i)) {
        printDebugTensorSummary("mha23", rank, i, -1, "decode.final_hidden",
                                subResultContainerDecode.getData(),
                                HiddenSize0);
        printDebugTensorSummary("mha23", rank, i, -1, "decode.logits",
                                resultDecode.getData(), MaxVocabSize);
      }
      ...
      addStage(metrics.decode, "decode", "log", "rank1.decode.print_iter",
               elapsedSeconds(tlog));
      if (shouldTraceDecodeIter(i)) {
        printDebugPredToken(rank, i, maxIndex, tok);
      }
    ...
    for (int i = 1; i <= generateLen; i++) {
      ...
      if (shouldTraceDecodeIter(i)) {
        printDebugScalar(rank, i, -1, "decode.cache_position",
                         cachePosition.getData()[0]);
        printDebugTensorSummary("mha23", rank, i, -1, "decode.recv_hidden",
                                subResultContainerDecode.getData(),
                                HiddenSize0);
      }
      ...
      for (int m = 0; m < times; m++) {
        ...
        if (m == 0) {
          ...
          if (shouldTraceDecodeIter(i)) {
            printDebugTensorSummary("mha23", rank, i, -1, "decode.recv_mask",
                                    mhaMemRef4DDecode.getData(),
                                    MaxTokenLength);
            printDebugTensorSummary("mha23", rank, i, -1, "decode.recv.cos",
                                    mhaMemRef3D1Decode.getData(), HiddenSize);
            printDebugTensorSummary("mha23", rank, i, -1, "decode.recv.sin",
