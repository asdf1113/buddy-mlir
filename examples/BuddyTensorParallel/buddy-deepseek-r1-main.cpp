...
extern "C" void _mlir_ciface_forward_prefill0(MemRefContainer *result,
                                             MemRef<float, 1> *arg0,
                                             Text<size_t, 2> *arg1);

extern "C" void _mlir_ciface_forward_decode0(
...
int main() {
  ...
  const std::string paramsDir = deepSeekR1BuildDir + "subgraph0_decode0_arg0.data";
  ...
  _mlir_ciface_forward_prefill0(ptrPrefillResultContainer, &ParamsContainer,
