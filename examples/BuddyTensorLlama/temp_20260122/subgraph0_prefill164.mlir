...
module {
  func.func @subgraph0_prefill164(%arg0: tensor<4096x2048xf32>, %arg1: tensor<4096x2048xf32>, %arg2: tensor<4096x2048xf32>, %arg3: tensor<2048x4096xf32>, %arg4: tensor<1x1x1024x1024xi1>, %arg5: tensor<1x1024x128xf32>, %arg6: tensor<1x1024x128xf32>, %arg7: tensor<1x1024x4096xf32>) -> (tensor<1x16x1024x128xf32>, tensor<1x16x1024x128xf32>, tensor<1024x4096xf32>) {
