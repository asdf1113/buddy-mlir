...
// RUN:   --model %t/rank0.rax --tensor-parallel-size 2 --max-tokens 7 2>&1 \
...
// TP2-COUNT-1: DeepSeekR1 Inference (buddy-cli / BuddyRuntime)
// TP2-DAG: Stage 5D.1 rank0 prefill/decode passed
// TP2-DAG: Stage 5D.1 rank1 prefill/decode passed
// TP2-DAG: Stage 5D.2 rank0 generation passed
// TP2-DAG: Stage 5D.2 rank1 generation passed
