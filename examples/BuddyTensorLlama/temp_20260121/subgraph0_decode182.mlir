...
"builtin.module"() ({
  "func.func"() <{function_type = (tensor<4096x2048xf32>, tensor<4096x2048xf32>, tensor<4096x2048xf32>, tensor<2048x4096xf32>, tensor<1xi64>, tensor<1x16x1024x128xf32>, tensor<1x16x1024x128xf32>, tensor<1x1x1x1024xi1>, tensor<1x1x128xf32>, tensor<1x1x128xf32>, tensor<1x1x4096xf32>) -> (tensor<1x16x1024x128xf32>, tensor<1x16x1024x128xf32>, tensor<1x4096xf32>), sym_name = "subgraph0_decode182"}> ({
